...
MAX_CHARS="${QWEN3_MAX_CHARS:-1200}"
MIN_CHARS="${QWEN3_MIN_CHARS:-600}"
MAX_NEW_TOKENS="${QWEN3_MAX_NEW_TOKENS:-4096}"
MAX_SEGMENT_DURATION="${QWEN3_MAX_SEGMENT_DURATION:-180}"
